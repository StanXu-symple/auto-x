...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("risk_acknowledged", sa.Boolean(), server_default=sa.false(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("declare_original", sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
