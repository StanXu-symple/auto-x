...
.xhs-hero,.main-panel,.card{border-color:var(--border);border-radius:16px;background:#fff;box-shadow:0 1px 2px rgba(18,24,40,.025),0 8px 28px rgba(18,24,40,.035)}
.xhs-hero{background:#fff}.hero-state{background:#fafbfc}.xhs-hero p,.card header p,.hint,.login-status small,.secure-list span,.content-preview,.qr-dialog p{color:var(--muted)}
.xhs-hero span{color:#d4373d}.card header svg{color:#d4373d}.login-status{background:var(--surface-2)}.error-copy{color:#b4233c;background:#fff5f6}
</style>
