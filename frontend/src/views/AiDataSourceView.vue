...
.source-hero,.panel,.architecture-strip{border-color:var(--border);border-radius:16px;background:#fff;box-shadow:0 1px 2px rgba(18,24,40,.025),0 8px 28px rgba(18,24,40,.035)}
.source-hero{background:#fff}.hero-icon,.panel header>span{color:var(--primary);background:var(--primary-soft);border-color:#dcd9ff}.eyebrow{color:var(--primary);letter-spacing:0}.hero-status{background:#fafbfc}
.source-hero p,.panel header p,.field-help,.security-note,.architecture-strip small,.status-grid small,.credential-panel footer{color:var(--muted)}.status-grid>span{border-color:var(--border);background:var(--surface-2)}.actions{border-color:var(--border)}.error-copy{color:#b4233c;background:#fff5f6}
</style>
