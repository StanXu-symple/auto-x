...
<section class="x-authorization-page source-page" v-loading="loading">
    ...
    <div v-else class="workspace-grid">
      ...
      <section class="panel credential-panel">
        ...
        <p class="security-copy"><ShieldCheck :size="16" />Cookie 加密持久化到 PostgreSQL；Redis 仅缓存密文。Worker 临时 SQLite 权限为 600，退出即删除。</p>
